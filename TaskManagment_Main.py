...
# Form implementation generated from reading ui file 'J:\Desktop\CS 361 Project\Test.ui'
#
...
class Ui_MainWindow(object):
    def __init__(self):
        ...
        self.socket.send_string("getDate")
        self.date = self.socket.recv_string()
...
"")
        ...
        self.inspectTask.setGeometry(QtCore.QRect(1175, 50, 321, 661))
        font = QtGui.QFont()
        ...
        self.addTodo.setGeometry(QtCore.QRect(20, 580, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Ink Free")
        ...
        self.beginTask.setGeometry(QtCore.QRect(20, 420, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Ink Free")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.deleteTask.setGeometry(QtCore.QRect(170, 630, 131, 31))
        palette = QtGui.QPalette()
        ...
        self.beginEdit.setGeometry(QtCore.QRect(20, 630, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Ink Free")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.editSave.setGeometry(QtCore.QRect(20, 360, 131, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(226, 231, 242))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        ...
        self.editCancel.setGeometry(QtCore.QRect(170, 360, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Ink Free")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.editDueDate.setMinimumDate(self.default_date)
        ...
        self.editTodoName.setGeometry(QtCore.QRect(20, 490, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Ink Free")
        font.setPointSize(12)
        ...
        self.label_28.setGeometry(QtCore.QRect(20, 470, 121, 16))
        font = QtGui.QFont()
        font.setFamily("Ink Free")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.editTodoCancel.setGeometry(QtCore.QRect(170, 540, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Ink Free")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.editTodoSave.setGeometry(QtCore.QRect(20, 540, 131, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(226, 231, 242))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
...
"color: rgb(92,98,116);")
        ...
        self.taskList.setColumnCount(4)
        ...
        item_0 = QtWidgets.QTreeWidgetItem(self.taskList)
        item_0 = QtWidgets.QTreeWidgetItem(self.taskList)
...
"QComboBox {background-color: rgb(255,255,255); border: 2px solid rgb(0,0,0); border-radius: 4px; font: bold 12pt \"Ink Free\";}\n"
        ...
        self.createDueDate.setMinimumDate(self.default_date)
...
"QComboBox {border: 2px solid rgb(0,0,0); border-radius: 4px; font: bold 12pt \"Ink Free\";}")
        ...
        self.label_2.setGeometry(QtCore.QRect(190, 90, 1131, 441))
...
"QPushButton:!enabled {background-color: rgb(161, 166, 179);}")
    ...
    def retranslateUi(self):
        ...
        self.taskList.topLevelItem(0).setText(0, _translate("self.MainWindow", "Test Item 2"))
        self.taskList.topLevelItem(0).setText(2, _translate("self.MainWindow", "10 Jan 2024"))
        self.taskList.topLevelItem(1).setText(0, _translate("self.MainWindow", "Test Item"))
        self.taskList.topLevelItem(1).setText(2, _translate("self.MainWindow", "11 Jan 2024"))
        ...
        self.label_2.setText(_translate("self.MainWindow", "00:00:00"))
    ...
    def string_to_time(self, text):
        seconds = int(round(float(text), 1))
        m, s = divmod(seconds, 60)
        h, m = divmod(m, 60)
        h = '0'+str(h) if h//10 <= 0 else str(h)
        m = '0'+str(m) if m//10 <= 0 else str(m)
        s = '0'+str(s) if s//10 <= 0 else str(s)
        return f'{h}:{m}:{s}'

    def init_timer(self):
        try:
            self.socket.send_string("getStopwatchTime")
        except:
            print("Pipeline not clear")
        message = self.socket.recv()
        message = message.decode()
        time = self.string_to_time(message)
    ...
    def begin_timer(self, check=False):
        ...
        if check == True:
            ...
            self.timer.stop()
            self.socket.send_string("stopTimer")
            self.socket.recv_string()
            

    def show_popup(self, title, text, funct, icon=QMessageBox.Question):
        reply = QMessageBox()
        reply.setText(text)
    ...
    def create_task(self):
        ...
        newItem.setText(2, _translate("Dialog", self.createDueDate.date().toString()))
    ...
    def delete_task(self):
        if self.taskList.selectedIndexes() != None:
            ...
            self.taskList.model().removeRow(idx)
    ...
    def update_task(self):
        ...
        if self.taskList.selectedIndexes() != None:
            ...
            self.taskList.topLevelItem(idx).setText(2, _translate("Dialog", self.editDueDate.date().toString()))
    ...
    def check_item_values(self):
        ...
        try:
            self.editDueDate.setDate(QtCore.QDate.fromString(item[2], "d MMM yyyy"))
        except:
            self.editDueDate.setDate(self.default_date)
        try:
            if item[3] == '':
